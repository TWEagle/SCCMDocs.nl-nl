---
title: Veelgestelde vragen over de Endpoint Protection-client | Microsoft-documenten
...
Deze veelgestelde vragen zijn voor computergebruikers waarvan de IT-beheerder Windows Defender of Endpoint Protection heeft geïmplementeerd op de beheerde computer. Hier de inhoud kan niet van toepassing op andere antimalware-software. Microsoft System Center Endpoint Protection beheert Windows Defender voor Windows 10. Het kan ook implementeren en beheren van de Endpoint Protection-client op computers voordat u Windows 10. In dit artikel wordt Windows Defender beschreven, maar de informatie is ook van toepassing op Endpoint Protection.  

-   [Waarom moet ik antivirus-en antispyware](#why-do-i-need-antivirus-and-antispyware-software)  
-   [Hoe weet ik of de computer is geïnfecteerd met schadelijke software](#how-can-i-tell-if-my-computer-is-infected-with-malicious-software)
-   [Hoe vind ik de versie van Windows Defender?](#how-can-i-find-the-version-of-windows-defender)
-   [Wat moet ik doen als Windows Defender of Endpoint Protection schadelijke software op mijn computer detecteert?](#what-should-i-do-if-windows-defender-or-endpoint-protection-detects-software-on-my-computer)  
-   [Wat is een virus?](#what-is-a-virus)  
-   [Wat is een spyware?](#what-is-spyware)  
...
-   [Vind ik schadelijke software zonder het te weten?](#can-i-get-malicious-software-without-knowing-it)  
-   [Waarom is het belangrijk om te bekijken van licentieovereenkomsten voordat u software installeert?](#why-is-it-important-to-review-license-agreements-before-installing-software)  
...
-   [Waarom niet cookies gedetecteerd door Windows Defender?](#why-doesn-t-windows-defender-detect-cookies)  
-   [Hoe voorkom ik schadelijke software](#how-can-i-prevent-malware)  
-   [Wat zijn de definities van virussen en spyware?](#what-are-virus-and-spyware-definitions)  
-   [Hoe ik definities van virussen en spyware up-to-date te houden?](#how-do-i-keep-virus-and-spyware-definitions-up-to-date)  
...
-   [Wat is real-timebeveiliging?](#what-is-real-time-protection)  
-   [Hoe weet ik of Windows Defender of Endpoint Protection wordt uitgevoerd op deze computer?](#how-do-i-know-that-windows-defender-or-endpoint-protection-is-running-on-my-computer)
-   [Het instellen van Windows Defender of Endpoint Protection waarschuwingen?](#how-to-set-up-windows-defender-or-endpoint-protection-alerts)  

##  <a name="why-do-i-need-antivirus-and-antispyware-software"></a>Waarom moet ik antivirus-en antispyware  
...
-   **Bij realtime-beveiliging** - real-timebeveiliging kan Windows Defender voor het bewaken van de computer de tijd en waarschuwingen u wanneer schadelijke software, inclusief virussen, spyware of andere mogelijk software ongewenste probeert te installeren of uit te voeren op uw computer. Windows Defender onderbreekt vervolgens de software, zodat u de aanbeveling met betrekking tot de software kunt volgen of alternatieve actie kunt ondernemen.  

    |**Real-timebeveiliging optie** |**doel** |

    |-|-|  
    | Alle downloads scannen | Deze optie controleert de bestanden en programma's die zijn gedownload, inclusief bestanden die automatisch worden gedownload via Windows Internet Explorer en Microsoft Outlook Express®, zoals ActiveX® besturingselementen en software-installatieprogramma's. Deze bestanden kunnen door de browser worden gedownload, geïnstalleerd of uitgevoerd. Schadelijke software, inclusief virussen, spyware en andere mogelijk ongewenste software, kan worden opgenomen in deze bestanden en zonder uw medeweten worden geïnstalleerd.<br /><br /> Met de optie realtime-beveiliging bewaakt Windows Defender voortdurend de computer en controleert deze op mogelijke schadelijke bestanden of programma's die u hebt gedownload. Dit betekent dat Windows Defender hoeven niet te vertragen websurfen of e-ervaring doordat een controle van alle bestanden en programma's u wilt misschien downloaden bewakingsfunctie. |  
    | Bestands- en programma-activiteit op uw computer | Deze optie controleert wanneer bestanden en programma's worden gestart op uw computer en klik er een waarschuwing gegeven over de acties die ze uitvoeren en de acties die daarop worden uitgevoerd. Dit is belangrijk, omdat schadelijke software gebruik kan maken van beveiligingslekken in programma's die u hebt geïnstalleerd om buiten uw medeweten schadelijke of ongewenste software uit te voeren. Spyware zichzelf bijvoorbeeld op de achtergrond uitvoeren wanneer u een programma start dat u vaak gebruikt. Windows Defender volgt uw programma's en u ontvangt een waarschuwing als er verdachte activiteit gedetecteerd. |  
    | Gedragscontrole inschakelen | Deze optie bewaakt verzamelingen van gedrag voor verdachte patronen die niet kan worden gedetecteerd door traditionele antivirusprogramma detectiemethoden. |  

    | Systeem voor Netwerkinspectie inschakelen | Deze optie kunt u uw computer beschermen tegen aanvallen van bekende beveiligingsproblemen 'nul day', verminderen van het venster van de tijd tussen het moment dat een beveiligingsprobleem wordt gedetecteerd en een update wordt toegepast. |  

-   **Opties voor scannen** -u kunt Windows Defender gebruiken om te scannen op mogelijke bedreigingen zoals virussen, spyware en andere kwaadaardige software die mogelijk risico voor de computer. U kunt ook regelmatige scans plannen en schadelijke software verwijderen die tijdens een scan wordt gedetecteerd.  

-   **Microsoft Active Protection Service community** -de onlinecommunity van Microsoft Active Protection Service kunt u zien hoe anderen reageren op software die nog niet zijn ingedeeld voor risico's. U kunt deze informatie gebruiken om te bepalen of u wilt toestaan dat deze software op uw computer wordt uitgevoerd. Als u deelneemt, worden uw keuzes toegevoegd aan de classificaties van de community om andere te helpen bepalen wat ze moeten doen.  

##  <a name="how-can-i-tell-if-my-computer-is-infected-with-malicious-software"></a>Hoe weet ik of de computer is geïnfecteerd met schadelijke software  
...
## <a name="how-can-i-find-the-version-of-windows-defender"></a>Hoe vind ik de versie van Windows Defender?
 Voor de versie van Windows Defender op uw computer, opent u Windows Defender (Klik op **Start** en zoek vervolgens naar **Windows Defender**), klikt u op **instellingen**, en Ga naar de onderkant van de instellingen voor Windows Defender vinden **versie-info**.

##  <a name="what-should-i-do-if-windows-defender-or-endpoint-protection-detects-malicious-software-on-my-computer"></a>Wat moet ik doen als Windows Defender of Endpoint Protection schadelijke software op mijn computer detecteert?  
...
-   **Verwijder** -deze actie verwijdert permanent de software op uw computer.  

-   **Quarantaine** -met deze actie de software quarantaine zodat deze kan niet worden uitgevoerd. Als Windows Defender software in quarantaine plaatst, wordt deze software verplaatst naar een andere locatie. Er wordt voorkomen dat de software wordt uitgevoerd totdat de software wordt teruggezet of van de computer wordt verwijderd.  

-   **Toestaan dat** -met deze actie wordt de software wordt toegevoegd aan de lijst met toegestane programma's in Windows Defender en kan worden uitgevoerd op uw computer. U wordt niet meer door Windows Defender gewaarschuwd over mogelijke risico's waaraan de software uw privacy of de computer kan blootstellen.  
...
##  <a name="can-i-get-malicious-software-without-knowing-it"></a>Vind ik schadelijke software zonder het te weten?  
 Ja, kan schadelijke software worden geïnstalleerd vanaf een website via een ingesloten script of een programma in een webpagina. Voor de installatie van andere schadelijke software is uw hulp vereist. Deze software maakt gebruik van pop-ups in uw browser of gratis software waarvoor u een downloadbaar bestand accepteert. Als u Microsoft Windows ® up-to-date te houdt en de beveiligingsinstellingen niet verlaagt, kunt u de kans op een infectie minimaliseren.  

##  <a name="why-is-it-important-to-review-license-agreements-before-installing-software"></a>Waarom is het belangrijk om te bekijken van licentieovereenkomsten voordat u software installeert?  
 Wanneer u websites bezoeken, niet automatisch accepteert downloaden van items die de site biedt. Lees zorgvuldig de gebruiksrechtovereenkomst van gratis software, zoals programma's voor het delen van bestanden of schermbeveiligers. Wees bedacht op zinnen waarin u wordt verplicht advertenties en pop-ups van het bedrijf te accepteren of waarin wordt aangegeven dat de software bepaalde gegevens verzendt naar de software-uitgever.  
...
##  <a name="why-doesnt-windows-defender-detect-cookies"></a>Waarom niet cookies gedetecteerd door Windows Defender?  
 Cookies zijn kleine tekstbestanden die websites op uw computer naar winkel informatie over u en uw voorkeuren plaatsen. Websites cookies gebruiken om een persoonlijke ervaring en voor het verzamelen van informatie over het gebruik van de website. Windows Defender biedt geen cookies gedetecteerd omdat deze niet deze een bedreiging voor uw privacy of voor de beveiliging van uw computer overwegen. De meeste internet browser's kunt u om cookies te blokkeren.  

##  <a name="how-can-i-prevent-malware"></a>Hoe voorkom ik schadelijke software  
...
-   Software op uw computer actueel te houden en vergeet niet alle patches worden geïnstalleerd. Werk uw besturingssysteem regelmatig bij.  
...
-   Download updates alleen van betrouwbare bronnen. Voor Windows-besturingssystemen altijd gaat u naar [Microsoft Update](http://go.microsoft.com/fwlink/?LinkID=96304) (http://go.microsoft.com/fwlink/?LinkID=96304) en andere software altijd gebruik voor de websites van het bedrijf of de persoon die deze produceert.  

-   Als u een e-mailbericht met een bijlage ontvangt en de bron niet vertrouwt, verwijdert u dit onmiddellijk. Niet alle toepassingen of bestanden downloaden van onbekende bronnen en wees voorzichtig met het handel bestanden met andere gebruikers.  

-   Installeer en gebruik een firewall. Het wordt aanbevolen Windows Firewall in te schakelen.  

##  <a name="what-are-virus-and-spyware-definitions"></a>Wat zijn de definities van virussen en spyware?  
...
##  <a name="how-do-i-keep-virus-and-spyware-definitions-up-to-date"></a>Hoe ik definities van virussen en spyware up-to-date te houden?  
...
### <a name="to-automatically-check-for-new-definitions-before-scheduled-scans-recommended"></a>Automatisch gecontroleerd op nieuwe definities voordat geplande scans (aanbevolen)  
...
### <a name="to-check-for-new-definitions-manually"></a>Nieuwe definities handmatig controleren

 Windows Defender of Endpoint Protection werkt automatisch de virus- en spywaredefinities op uw computer bij. Als de definities niet zijn bijgewerkt voor meer dan zeven dagen (bijvoorbeeld als u de computer niet inschakelen voor een week), waarschuwt Windows Defender of Endpoint Protection u dat de definities verouderd zijn.  
...
###  <a name="to-remove-or-restore-items-quarantined-by-windows-defender-or-endpoint-protection"></a>Om te verwijderen of in quarantaine geplaatst door Windows Defender of Endpoint Protection items herstellen
...
##  <a name="what-is-real-time-protection"></a>Wat is real-timebeveiliging?  

 Realtime-beveiliging zorgt ervoor dat Windows Defender de computer continu bewaakt en waarschuwt u wanneer mogelijke bedreigingen zoals virussen en spyware, probeert zichzelf te installeren of uit te voeren op uw computer. Omdat deze functie een belangrijk aspect vormt van de manier waarop Windows Defender uw computer beschermt, moet u ervoor zorgen dat realtime-beveiliging altijd is ingeschakeld. Als real-timebeveiliging opgehaald uitgeschakeld, Windows Defender een melding en uw computer€ wijzigt™ s de status ' œAt riskâ ' uit.  
...
|Systeem voor netwerkinspectie inschakelen|Deze optie kunt u uw computer beschermen tegen â €œzero dayâ€ aanvallen van bekende beveiligingsproblemen, verminderen van het venster van de tijd tussen het moment dat een beveiligingsprobleem wordt gedetecteerd en een update wordt toegepast.|  
...
##  <a name="how-do-i-know-that-windows-defender-or-endpoint-protection-is-running-on-my-computer"></a>Hoe weet ik of Windows Defender of Endpoint Protection wordt uitgevoerd op deze computer?  
...
>Als er geen het pictogram Windows Defender in het systeemvak te plaatsen, klikt u op de pijl in het systeemvak verborgen pictogrammen, inclusief het pictogram Windows Defender weer te geven.  
...
##  <a name="how-to-set-up-windows-defender-or-endpoint-protection-alerts"></a>Het instellen van Windows Defender of Endpoint Protection waarschuwingen?  
