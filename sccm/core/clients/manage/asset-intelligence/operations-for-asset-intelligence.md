---
title: Asset Intelligence gebruiken | Microsoft-documenten
description: Algemene Asset Intelligence-taken in System Center Configuration Manager uitvoeren.
ms.custom: na
ms.date: 2/22/2017
...
Dit onderwerp bevat informatie over het beheren van typische Asset Intelligence-taken in de System Center Configuration Manager-hiërarchie:  
...
-   **Synchronisatie van catalogus**: Bevat informatie over of Asset Intelligence is ingeschakeld, worden de huidige status van het Asset Intelligence-synchronisatiepunt, de synchronisatieplanning, of de klant Licentieverklaring wordt geïmporteerd, wanneer de status voor het laatst is bijgewerkt en de tijd voor de volgende geplande update en het aantal wijzigingen die zijn opgetreden nadat het sitesysteem van Asset Intelligence-synchronisatie-punt is geïnstalleerd.  
...
-   **Status van de Software geïnventariseerde**: Geeft het aantal en percentage van de geïnventariseerde software, softwarecategorieën en softwarefamilies die door Microsoft, geïdentificeerd door een gebruiker met beheerdersrechten in afwachting van online identificatie of niet geïdentificeerd en niet in afwachting worden geïdentificeerd. De informatie in tabelindeling bevat het aantal voor elke softwaretoepassing, terwijl de informatie in de grafiek het percentage voor elke softwaretoepassing toont.  
...
> [!IMPORTANT]  
>  De hardwarevereisten weergegeven in de Configuration Manager-console worden opgehaald uit de Asset Intelligence-catalogus op de lokale computer en niet op basis van de titel informatie over geïnventariseerde software van System Center 2012 Configuration Manager-clients. Informatie over hardwarevereisten wordt niet bijgewerkt tijdens de synchronisatie met System Center Online. U kunt door de gebruiker gedefinieerde hardwarevereisten maken voor geïnventariseerde software die geen bijbehorende hardwarevereisten heeft.  
...
4.  Voer op de pagina **Algemeen** de volgende informatie in:  
    ...
    2.  **Validatiestatus**: Geeft een lijst van de validatiestatus als **gedefinieerd door de gebruiker** voor de hardwarevereisten voldoet. U kunt deze instelling niet wijzigen.  

    3.  **Minimale CPU (MHz)**: Hiermee geeft u de minimale processorsnelheid, in megahertz (MHz) vereist voor de softwaretitel.  

    4.  **Minimale hoeveelheid RAM (KB)**: Hiermee geeft u de minimale hoeveelheid RAM, in kilobyte (KB), vereist voor de softwaretitel.  

    5.  **Minimale schijfruimte (KB)**: Hiermee geeft u de minimale vrije schijfruimte in KB, door de softwaretitel vereist.  

    6.  **Minimale grootte (KB)**: Geeft de minimale hardeschijfomvang in KB, vereist voor de softwaretitel.  
...
5.  Op het tabblad **Algemeen** kunt u de volgende categorisatie-informatie wijzigen:  
    ...
    -   **Productnaam**: Hiermee geeft u de naam van de titel van de geïnventariseerde software.  
...
### <a name="revert-categorization-information-to-original-settings-for-software"></a>Categorisatie-informatie terugzetten naar de oorspronkelijke software-instellingen  
 Configuration Manager slaat categorisatie informatie verkregen van System Center Online in de database. De informatie kan niet worden verwijderd. Nadat de informatie is gewijzigd, kunt u deze terugzetten naar de System Center Online-categorisatie. Geïnventariseerde software die niet in de Asset Intelligence-catalogus voorkomt kan ook worden teruggezet naar de oorspronkelijke instellingen.  
...
> [!NOTE]  
>  Zie voor meer informatie over Asset Intelligence privacygegevens [beveiliging en privacy voor Asset Intelligence in System Center Configuration Manager](../../../../core/clients/manage/asset-intelligence/security-and-privacy-for-asset-intelligence.md).  
...
5.  Controleer de volgende informatie:  
    ...
    -   **Lokale waarde**: Hiermee geeft u de bestaande software categorisatie informatie in de Asset Intelligence-catalogus die in conflict met nieuwere System Center Online software categorisatie details.  

    -   **Waarde gedownload**: Hiermee geeft u een nieuwe System Center Online categorisatie informatie over de software voor conflicterende Asset Intelligence-catalogus software categorisatie-informatie.  

6.  Selecteer een van de volgende instellingen om het conflict met softwaredetails op te lossen:  

    -   **Wijzig de waarde van de gegevens lokaal bewerkte catalogus niet**: De software details conflict opgelost door te behouden de bestaande Asset Intelligence-catalogus categorisatie informatie over de software. Wanneer u deze instelling selecteert, wordt de status van de softwaretitel veranderd van **Bijwerkbaar** in **Door de gebruiker gedefinieerd**.  

    -   **De waarde van de gegevens lokaal bewerkte catalogus overschreven met de gedownloade System Center Online waarde**: De software details conflict opgelost door de bestaande Asset Intelligence-catalogus categorisatie informatie over de software wordt overschreven door nieuwe informatie verkregen van System Center Online. Wanneer u deze instelling selecteert, wordt de status van de softwaretitel veranderd van **Bijwerkbaar** in **Gevalideerd**.  
