---
title: Hierarchy Maintenance Tool | Microsoft-documenten
description: Begrijpen wat de Hierarchy Maintenance Tool doet en waarom u deze kunt gebruiken. Opdrachtregelopties verwijzing bevat.
ms.custom: na
ms.date: 10/06/2016
...
-   Verwijderen van de Configuration Manager-console een siteserver wanneer u niet de site verwijderen bent met behulp van Setup. Als u een Configuration Manager-site zonder eerst Setup uit te voeren voor het verwijderen van de site fysiek verwijdert, zal de informatie van de site nog bestaan in de database van de bovenliggende site en de bovenliggende site zal blijven proberen om te communiceren met de onderliggende site. Dit probleem wilt oplossen, moet u het Hiërarchieonderhoud-hulpprogramma uitvoeren en de onderliggende site handmatig verwijderen uit de database van de bovenliggende site.  

-   Alle Configuration Manager-services op een site zonder afzonderlijk te moeten stoppen services stoppen.  
...
Wanneer u het Hiërarchieonderhoud-hulpprogramma uitvoert, moet u de volgende syntaxis: preinst.exe /&lt;optie\>. Hieronder vindt u de opdrachtregelopties.  

 **/ DELJOB &lt;* SiteCode*> **-Gebruik deze optie op een site om alle taken of opdrachten verwijderen uit de huidige site tot de gespecificeerde doelsite.  
...
> [!NOTE]  
>  De /DELSITE-optie maakt de installatie van de site op de computer, opgegeven door de ChildSiteCodeToRemove-parameter, niet ongedaan. Deze optie verwijdert alleen de site-informatie uit de sitedatabase van Configuration Manager.  
...
Een installatiekopie is een binaire weergave van het sitebesturingsbestand is opgeslagen in de Configuration Manager-sitedatabase. De gedumpte installatiekopie van het sitebeheerbestand is een som van de basisinstallatiekopie plus de hangende installatiekopieën van de verschillen.  

Ne het dumpen van een installatiekopie van het bestand met het hulpprogramma voor hiërarchie-onderhoud, de bestandsnaam is in het formaat sitectrl_&lt;*SiteCode*> .ct0.  

**/ STOPSITE** -Gebruik deze optie op de lokale siteserver om een afsluitcyclus voor de service Site Component Manager Configuration Manager, die de site gedeeltelijk terugzet te initiëren. Wanneer deze afsluitcyclus uitgevoerd wordt, worden sommige Configuration Manager-services op een siteserver en zijn externe sitesystemen gestopt. Deze services zijn gemarkeerd voor opnieuw installeren. Tengevolge van deze afsluitcyclus, worden sommige wachtwoorden automatisch gewijzigd wanneer de services worden geïnstalleerd.  
...
De/keyforparent-optie plaatst de openbare sleutel van de site in het bestand &lt; *SiteCode*>. CT4 in de hoofdmap van het programma bestanden station. Kopieer, nadat u preinst.exe hebt uitgevoerd met deze optie, het &lt; *SiteCode*>. CT4-bestand naar de bovenliggende site...\Inboxes\hman.box map (niet hman.box\pubkey).  

**/KEYFORCHILD**: gebruik deze optie op een site om de openbare sleutel van de site te verdelen naar een onderliggende site.  

De/keyforparent-optie plaatst de openbare sleutel van de site in het bestand &lt; *SiteCode*>. CT5 in de hoofdmap van het programma bestanden station. Kopieer, nadat u preinst.exe hebt uitgevoerd met deze optie, het &lt; *SiteCode*>. CT5-bestand naar de onderliggende site...\Inboxes\hman.box map (niet hman.box\pubkey).  
...
De childkeys-optie plaatst de sleutel van de site waar u de optie uitvoert, en alle onderliggende sites van openbare sleutels in het bestand &lt; *SiteCode*>. CT6.  

Kopieer, nadat u preinst.exe hebt uitgevoerd met deze optie, het &lt; *SiteCode*>. CT6-bestand naar de herstellende site...\Inboxes\hman.box map (niet hman.box\pubkey).  
...
De parentkeys-optie plaatst de sleutel van de site waar u de optie uitvoert en de sleutels van de bovenliggende site deze site in het bestand &lt;SiteCode\>. CT7.  

Kopieer, nadat u preinst.exe hebt uitgevoerd met deze optie, het &lt; *SiteCode*>. CT7-bestand naar de herstellende site...\Inboxes\hman.box map (niet hman.box\pubkey).  
...
3.  De/keyforparent-optie plaatst de openbare sleutel van de onderliggende site in de  **&lt;sitecode\>. CT4** bestand te vinden in de hoofdmap van het systeemstation.  
...
2.  Typ het volgende als u wilt de openbare sleutel van de bovenliggende site exporteren: **Preinst/keyforchild**.  

3.  De/keyforparent-optie plaatst de openbare sleutel van de bovenliggende site in de  **&lt;sitecode\>. CT5** bestand te vinden in de hoofdmap van het systeemstation.  
