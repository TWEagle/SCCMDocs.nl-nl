---
title: Lijst met rapporten | Microsoft-documenten
...
## <a name="list-of-built-in-configuration-manager-reports"></a>Lijst met ingebouwde rapporten voor Configuration Manager  
 De volgende rapporten zijn opgenomen met Configuration Manager. De rapporten worden in verschillende categorieën weergegeven.  

### <a name="administrative-security"></a>Administratieve beveiliging  
 De volgende rapporten worden weergegeven onder de **administratieve beveiliging** categorie.  

|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Beheer-logboek**|Geeft een record weer van administratieve wijzigingen voor beheergebruikers, beveiligingsrollen, beveiligingsbereiken en verzamelingen.|  
|**Gebruikers met beheerdersrechten beveiligingstoewijzingen**|Geeft beheergebruikers, de bijbehorende beveiligingsrollen en de beveiligingsbereiken die zijn gekoppeld aan elke rol voor elke gebruiker weer.|  
...
|**Samenvatting beveiligingsrollen**|Geeft de beveiligingsrollen en de Configuration Manager-beheerders die zijn gekoppeld aan elke rol.|  
|**Beveiligingsbereiken samenvatting**|Geeft de beveiligingsbereiken en de Configuration Manager-beheerders en beveiligingsgroepen die zijn gekoppeld aan elk bereik.|  

### <a name="alerts"></a>Waarschuwingen  

|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Waarschuwing scorecard**|Geeft een samenvatting weer van alle uitgestelde waarschuwingen die zijn gegenereerd tussen de opgegeven begindatum en einddatum.|  
|**Vaakst gegenereerde waarschuwingen**|Geeft een samenvatting weer van de waarschuwingen die het meest zijn gegenereerd vanaf de opgegeven datum voor het opgegeven functiegebied tot dit moment.|  
...
|**Hardware 06A - Computers waarvoor consolegebruikers gebruikers kunnen niet worden bepaald**|Helpt beheerdergebruikers bij de identificatie van computers waarvoor het vastleggen van gebeurtenissen in het beveiligingslogboek moet worden ingeschakeld.|  
...
|**Hardware 08A - Hardware die niet gereed is voor een software-upgrade**|Hardware die niet voldoet aan de minimale hardwarevereisten.|  
...
|**Licentie 01C - Computers met een specifiek Microsoft Volume License-grootboek en verkoopkanaal kanaal**|Identificeert en toont computers die een opgegeven item bevatten uit het Microsoft Volume License-grootboek.|  
...
|**Licentie 02A - aantal licenties die bijna zijn verlopen door tijdsbereik**|Geeft het aantal licenties weer dat binnenkort verloopt op basis van een opgegeven tijdperiode. De weergegeven producten zijn producten waarvan de licenties worden beheerd door de Software Licensing-service.|  
|**Licentie 02B - Computers met licenties die bijna verlopen**|Geeft de opgegeven computers weer met licenties die binnenkort verlopen.|  
...
|**Licentie 03A - telling van licenties op licentiestatus**|Geeft producten weer, op licentiestatus, waarvan de licenties worden beheerd door de Software Licensing-service.|  
...
|**Licentie 06A - statistieken voor de producten per processor zijn gelicentieerd**|Geeft het aantal processoren weer op computers die Microsoft-producten gebruiken die licentieverlening per processor ondersteunen.|  
...
|**Licentie 14B - lijst van Microsoft-software-inventarisatie niet is gevonden in MVLS**|Dit rapport geeft Microsoft-softwaretitels weer die in gebruik zijn en die niet zijn gevonden in de Microsoft Volume License Agreement.|  
...
|**Licentie 15B - rapport algemene licentie-afstemming door computer**|Geeft computers weer waarop het gelicentieerde product is geïnstalleerd met een opgegeven versie.|  
...
|**Software 04B - Computers met specifieke software die is geconfigureerd dat automatisch wordt uitgevoerd**|Geeft alle computers weer met opgegeven software die is geconfigureerd om automatisch te worden uitgevoerd|  
|**Software 04C - Software die zijn geconfigureerd voor automatisch wordt uitgevoerd op een specifieke computer**|Geeft geïnstalleerde software weer die is geconfigureerd om automatisch te worden uitgevoerd op een opgegeven computer|  
...
|**Software 07B - Computers gebruikt die recent een opgegeven uitvoerbaar programma**|Geeft de computers weer waarop een opgegeven uitvoerbaar programma recent is gebruikt wanneer u de clientinstelling voor het controleren van softwarelicenties inschakelt.|  
...
|**Software 08B - gebruikers gebruikt die recent een opgegeven uitvoerbaar programma**|Geeft de gebruikers weer die het meest recent een opgegeven uitvoerbaar programma hebben gebruikt wanneer u de clientinstelling voor het controleren van softwarelicenties inschakelt.|  
...
|**Software 10B - Computers met een specifieke software die is aangepast etiket is geïnstalleerd**|Geeft alle computers in deze verzameling weer waarvoor de opgegeven softwaretitel met aangepast etiket is geïnstalleerd.|  
|**Software 11A - softwaretitels met een specifiek aangepast etiket is gedefinieerd**|Geeft softwaretitels weer op basis van overeenkomst met ten minste een van de opgegeven criteria voor aangepaste etiketten.|  
...
|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Details van status van client-push-installatie**|Geeft informatie weer over het clientpushinstallatieproces voor alle sites.|  
|**Client push installation-statusgegevens voor een opgegeven site**|Geeft informatie weer over het clientpushinstallatieproces voor een opgegeven site.|  
|**Samenvatting van status van client-push**|Geeft samenvatting weer over het clientpushinstallatieproces voor alle sites.|  
|**Status van clientpushinstallatie samenvatting voor een opgegeven site**|Geeft samenvatting weer over het clientpushinstallatieproces voor een opgegeven site.|  

### <a name="client-status"></a>Clientstatus  

|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Herstel van clientgegevens**|Geeft details weer over clientherstelacties voor een verzameling die u opgeeft.|  
|**Herstel van clients samenvatting**|Geeft een samenvatting weer over clientherstelacties voor een opgegeven verzameling.|  
|**Geschiedenis van de client-status**|Geeft een historisch overzicht weer van de algemene clientstatus in de site.|  
...
|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Geschiedenis voor uitgifte van certificaat**|Geeft de geschiedenis van certificaten weer die door het certificaatregistratiepunt voor het opgegeven datumbereik zijn uitgegeven aan gebruikers en apparaten.|  
...
|**Lijst van activa met certificaten die bijna verloopt**|Geeft de apparaten of gebruikers weer met certificaten die op of voor de opgegeven datum vervallen.|  
...
|**Lijst van assets per compatibiliteitsstatus voor een configuratie-item in een configuratiebasislijn**|Geeft de apparaten of gebruikers weer in een opgegeven compatibiliteitsstatus na de evaluatie van een opgegeven configuratie-item.|  
|**Lijst van assets per compatibiliteitsstatus voor een configuratiebasislijn**|Geeft de apparaten of gebruikers weer in een opgegeven compatibiliteitsstatus na de evaluatie van een opgegeven configuratiebasislijn.|  
...
|**Regels en fouten samenvatting van configuratie-items in een configuratiebasislijn voor een asset**|Geeft een samenvatting weer van de compatibiliteitsstatus van regels, en eventuele instellingsfouten voor een opgegeven configuratie-item dat is geïmplementeerd voor een opgegeven apparaat of gebruiker.|  
...
|**Samenvatting van compatibiliteit van een configuratiebasislijn voor een verzameling**|Geeft een samenvatting weer van de algemene compatibiliteit van een opgegeven configuratiebasislijn die is geïmplementeerd op een opgegeven verzameling.|  
...
|**Voorwaarden en bepalingen accepteren**|Geeft de voorwaarden weer en de versie die door elke gebruiker is geaccepteerd.|  
...
|**Certificaatproblemen op mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE en die zijn beschadigd**|Geeft gedetailleerde informatie over certificaatproblemen op mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE.|  
|**Mislukte clientimplementaties voor mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE**|Geeft gedetailleerde informatie over mislukte implementaties voor mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE.|  
|**Clientimplementatiestatus voor mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE**|Geeft informatie weer over de status van mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE.|  
|**Geslaagde clientimplementaties voor mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE**|Geeft gedetailleerde informatie over geslaagde implementaties voor mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE.|  
|**Communicatieproblemen op mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE en die zijn beschadigd**|Dit rapport bevat gedetailleerde informatie over communicatieproblemen op mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE.|  
...
|**Statusgegevens voor mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE**|Geeft gedetailleerde statusgegevens voor mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE.|  
|**Status van samenvatting voor mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE**|Status geeft samenvattingsinformatie weer voor mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE.|  
...
|**Lijst met apparaten geregistreerd per gebruiker in Microsoft Intune**|Hier ziet u alle apparaten die per gebruiker zijn ingeschreven met Microsoft Intune.|  
|**Lijst van apparaten op voorwaardelijke toegangsstatus**|Geeft informatie weer over de huidige naleving en de status van voorwaardelijke toegang van apparaten. U kunt dit rapport gebruiken met beleidsregels voor voorwaardelijke toegang. Dit rapport is beschikbaar vanaf versie 1602 van Configuration Manager.|  
|**Compatibiliteit van voorwaardelijke toegang voor gebruiker**|Biedt gedetailleerde compatibiliteitsinformatie voor voorwaardelijke toegang over een specifieke gebruiker, met inbegrip van de apparaatnaam en het platform, of het apparaat compatibel is, en wanneer het apparaat voor het laatst is geëvalueerd. Dit rapport is beschikbaar vanaf versie 1602 van Configuration Manager.|  
|**Lokale-clientproblemen op mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE en die zijn beschadigd**|Dit rapport bevat gedetailleerde informatie over lokale-clientproblemen op mobiele apparaten die worden beheerd door de Configuration Manager-client voor Windows CE.|  
|**Clientinformatie van mobiele apparaten**|Geeft informatie weer over de mobiele apparaten waarop de Configuration Manager-client is geïnstalleerd. U kunt dit rapport gebruiken om te controleren welke mobiele apparaten kunnen communiceren met een beheerpunt.|  
...
|**Mobiele apparaten die opengebroken of geroot apparaat zijn**|Geeft de mobiele apparaten weer die zijn opengebroken of geroot.|  
|**Mobiele apparaten die beheerd worden omdat ze zijn geregistreerd maar toewijzen aan een site is mislukt**|De mobiele apparaten weergegeven die registratie bij Configuration Manager voltooid en een certificaat, maar kan de sitetoewijzing voltooien hebben.|  
...
|**Mobiele apparaten met problemen bij het verlengen van certificaat**|Geeft de geregistreerde apparaten weer waarvan het verlengen van het certificaat is mislukt. Als het certificaat niet wordt verlengd vóór de verloopperiode, zijn de mobiele apparaten onbeheerd.|  
...
|**Mobiele apparaten met weinig vrij wisselbare-opslaggeheugen (minder dan opgegeven aantal KB vrij)**|Geeft de mobiele apparaten weer waarvoor het verwijderbare geheugen lager is dan een opgegeven grootte in KB.|  
|**Aantal geregistreerde apparaten per gebruiker in Windows Intune**|Dit rapport bevat gebruikers voor wie het Microsoft Intune-abonnement en het totale aantal geregistreerde apparaten voor elke gebruiker.|  
|**Aanvraag voor mobiele apparaten wissen in behandeling**|Geeft de verzoeken om te wissen weer die in behandeling zijn voor mobiele apparaten.|  
|**Onlangs ingeschreven en mobiele apparaten toegewezen**|Hiermee geeft u mobiele apparaten die recent zijn geregistreerd met Configuration Manager en is toegewezen aan een site.|  
...
|**Stuurprogramma's die niet kon worden geïnstalleerd op een specifieke computer**|Geeft de stuurprogramma's weer die niet konden worden geïnstalleerd op een opgegeven computer.|  
...
|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Rapport van Antimalware-activiteit**|Geeft een overzicht van activiteit tegen malware.|  
|**Algemene status van schadelijke software en geschiedenis**|Geeft de algemene status en geschiedenis weer van antimalware.|  
...
|**Lijst met gebruikers bedreiging**|Geeft een lijst met bedreigingen weer voor een opgegeven gebruikersaccount.|  

### <a name="hardware---cd-rom"></a>Hardware - cd  
...
|**Cd-romstations tellen per fabrikant**|Geeft het aantal cd-romstations weer dat is geïnventariseerd per fabrikant.|  
...
|**Computers met weinig vrije ruimte (minder dan MB vrij opgegeven)**|Geeft een lijst weer van computers en schijven met weinig schijfruimte. De grootte van de te controleren vrije ruimte is opgegeven in MB.|  
...
|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Computers waarbij fysiek geheugen is gewijzigd**|Geeft een lijst met computers weer waarbij de hoeveelheid RAM is gewijzigd sinds de laatste inventarisatiecyclus.|  
...
|**Aantal geheugenconfiguraties**|Geeft het aantal computers weer dat is geïnventariseerd op hoeveelheid RAM.|  
...
|**Aantal processorsnelheden**|Geeft het aantal computers weer dat is geïnventariseerd op processorsnelheid.|  
...
|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Typ voor computers met een specifieke SCSI-kaart**|Geeft een lijst weer van computers met een opgegeven type SCSI-kaart.|  
...
|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Computers met een opgegeven geluidskaart**|Geeft een lijst weer van computers met een opgegeven geluidskaart.|  
|**Aantal geluidskaarten**|Geeft het aantal computers weer dat is geïnventariseerd op elk type geluidskaart.|  
...
|**Aantal videokaarten op type**|Geeft een lijst weer met alle videokaarten die op computers zijn geïnstalleerd, samen met het aantal van elk type videokaart.|  
...
|**Eigenschappen van migratie**|In dit rapport wordt de inhoud weer van de opgegeven migratietaak weergegeven.|  
...
|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Vergelijking van software-updates geïnstalleerd door software update-implementaties en NAP-herstel.**|Geeft een vergelijkingssamenvatting weer van software-updates die zijn geïnstalleerd door software-update-implementaties en NAP-herbemiddeling|  
...
|**Lijst met computers waarop een specifieke software-update via herbemiddeling gedurende een bepaalde periode is geïnstalleerd**|Geeft een lijst weer met computers waarop tijdens een opgegeven periode (dagen) een opgegeven software-update is geïnstalleerd via herbemiddeling.|  
...
|**Lijst met computers waarop NAP-service niet kan worden herkend**|Geeft een lijst weer met computers waarop NAP-service niet is gedetecteerd.|  
...
|**Lijst met NAP-beleid**|Geeft een lijst weer van beleidsregels voor netwerktoegangsbeveiliging met de bijbehorende ingangsdatums.|  
...
|**Lijst met herbemiddelingen voor een opgegeven periode installeren**|Geeft een lijst weer met mislukte herbemiddelingen voor een opgegeven aantal dagen.|  
|**Lijst met software-updates geïnstalleerd via herbemiddeling**|Geeft de lijst weer met software-updates die zijn geïnstalleerd via herbemiddeling voor een opgegeven periode.|  
...
|**Computers met een specifiek besturingssysteem en servicepakket**|Geeft computers weer met een specifiek besturingssysteem en servicepack.|  
...
|**Services - Computers met een specifieke service**|Geeft een lijst weer van computers waarop een opgegeven service wordt uitgevoerd.|  
...
|**Services - informatie over Services voor een specifieke computer**|Geeft samenvattingsinformatie weer over de services op een opgegeven computer.|  
...
|**Buiten-bandbeheer console-activiteit**|Geeft een lijst weer van statusberichten die console-activiteit in out-of-boundbeheer identificeren.|  
...
|**Energiebeheer - details van Computer**|Geeft gedetailleerde informatie weer over de energiemogelijkheden, energie-instellingen en energiebeheerschema's die worden toegepast op een opgegeven computer.|  
|**Energiebeheer - Computer geen details**|Geeft een lijst weer van computers waar waarvoor op een opgegeven datum en tijdstip geen stroomactiviteit is gerapporteerd.|  
...
|**Energiebeheer - uitwerking op milieu**|Geeft een grafiek weer met CO2-uitstoot die wordt gegenereerd door een specifieke verzameling gedurende een specifieke periode.|  
|**Energiebeheer - uitwerking op milieu per dag**|Geeft een grafiek weer met CO2-uitstoot die wordt gegenereerd door een specifieke verzameling gedurende de afgelopen 31 dagen.|  
...
|**Energiebeheer - Slapeloosheid rapport**|Geeft een lijst met algemene oorzaken aan waardoor de slaap- of sluimerstand niet kan worden ingeschakeld, en het aantal computers waarop elke oorzaak van toepassing is voor een opgegeven periode.|  
...
|**Energiebeheer - details van energie-instellingen**|Gebruikt voor verdere informatie weergegeven over computers die zijn opgegeven in de **energiebeheer - energie-instellingen** rapport.|  
...
|**Koppeling replicatieverkeer**|Geeft het totale replicatieverkeer weer voor alle gegevens gedurende een opgegeven aantal dagen.|  
...
|**Totaal replicatieverkeer in hiërarchie (lijndiagram)**|Geeft de verzamelde globale gegevens in de hiërarchie en gegevensreplicatie van de site weer voor elke richting van elke koppeling gedurende een opgegeven aantal dagen.|  
|**Totaal replicatieverkeer in hiërarchie (cirkeldiagram)**|Geeft de verzamelde globale gegevens in de hiërarchie en gegevensreplicatie van de site weer voor elke richting van elke koppeling gedurende een opgegeven aantal dagen.|  

### <a name="site---client-information"></a>Site - clientgegevens  
...
|**Statusdetails van toewijzing**|Geeft overzichtsinformatie weer over de status van clienttoewijzingen.|  
|**Details van slagen van client-toewijzing**|Geeft gedetailleerde informatie weer over geslaagde clienttoewijzingen.|  
|**Rapport over fout clientimplementatie**|Geeft gedetailleerde informatie weer voor clients die niet kunnen worden geïmplementeerd.|  
...
|**Clients die geen HTTPS-communicatie**|Geeft gedetailleerde informatie weer over elke client in een site die de HTTPS Communication Readiness Tool heeft uitgevoerd en waarvan is aangegeven dat deze niet kan communiceren via HTTPS.|  
|**Computers toegewezen maar niet geïnstalleerd voor een bepaalde site**|Geeft een lijst weer van computers die zijn toegewezen aan een opgegeven site, maar die niet rapporteren aan deze site.|  
|**Computers met een specifieke clientversie van de Configuration Manager**|Geeft een lijst van computers met een opgegeven versie van de Configuration Manager-clientsoftware.|  
...
|**Telling van Configuration Manager-clients op clientversies**|Geeft het aantal computers die zijn gedetecteerd door Configuration Manager-clientversie.|  
...
|**Samenvatting van problemen die worden gerapporteerd aan het terugvalstatuspunt**|Geeft informatie weer over alle problemen die zijn gerapporteerd door clients als aan deze een terugvalstatuspunt is toegewezen.|  
|**Samenvatting van problemen die worden gerapporteerd aan het terugvalstatuspunt voor een specifieke verzameling**|Geeft samenvattingsinformatie weer voor problemen die worden gerapporteerd door clients in een opgegeven verzameling als aan deze een terugvalstatuspunt is toegewezen.|  

### <a name="site---discovery-and-inventory-information"></a>Site - detectie en inventarisatie-informatie  

|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Clients die niet hebben gerapporteerd onlangs (in een opgegeven aantal dagen)**|Geeft een lijst weer van clients waarvan geen detectiegegevens, hardware-inventarisatie of software-inventarisatie is gerapporteerd gedurende een opgegeven aantal dagen.|  
...
|**Computers die zijn gedetecteerd door detectiemethode.**|Geeft een lijst weer met computers die zijn gedetecteerd binnen het opgegeven aantal dagen, en een lijst van de agenten die ze hebben gedetecteerd. Een computer kan meer dan eens in de lijst voorkomen als deze is gedetecteerd door meerdere agents.|  
|**Computers die niet recent gedetecteerd (in een opgegeven aantal dagen)**|Geeft een lijst weer met computers die niet recent zijn ontdekt, en geeft weer hoeveel dagen geleden deze zijn ontdekt.|  
|**Computers niet geïnventariseerd onlangs (in een opgegeven aantal dagen)**|Geeft een lijst met computers weer die niet recent zijn geïnventariseerd, en geeft de laatste keer weer dat deze zijn geïnventariseerd.|  
|**Computers die mogelijk de unieke id van Configuration Manager**|Geeft een lijst weer van computers waarvan de naam is veranderd. Een wijziging in de naam is kan erop duiden dat een computer met een unieke Configuration Manager-id met een andere computer deelt.|  
...
### <a name="site---server-information"></a>Site - informatie  
...
|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Alle implementaties van toepassingen (Geavanceerd)**|Geeft gedetailleerde samenvattingsinformatie weer voor alle software-implementaties.|  
|**Alle implementaties van toepassingen (basis)**|Geeft samenvattingsinformatie weer voor alle software-implementaties.|  
|**Compatibiliteit van toepassing**|Geeft gedetailleerde informatie weer over de compatibiliteit van de opgegeven toepassing binnen de opgegeven verzameling.|  
...
|**Gebruik samenvatting toepassingsstatus**|Geeft een gebruikssamenvatting weer voor geïnstalleerde toepassingen.|  
...
|**Toepassingen die zijn gericht op distributiepunt**|Geeft informatie weer over de toepassingsinhoud die is geïmplementeerd naar een opgegeven distributiepuntengroep.|  
|**Toepassingen die niet gesynchroniseerd op een opgegeven distributiepuntengroep zijn wijst groep**|Geeft de toepassingen weer waarvoor gekoppelde inhoudsbestanden niet zijn bijgewerkt met de laatste versie op een opgegeven distributiepuntengroep.|  
...
|**Pakketten die zijn gericht op distributiepunt**|Geeft informatie weer over pakketten die zijn gericht op een opgegeven distributiepuntengroep.|  
|**Pakketten die niet gesynchroniseerd op een opgegeven distributiepuntengroep zijn wijst groep**|Geeft de pakketten weer waarvoor gekoppelde inhoudsbestanden niet zijn bijgewerkt met de laatste versie op een opgegeven distributiepuntengroep.|  

### <a name="software-distribution---package-and-program-deployment"></a>Softwaredistributie - pakket en programma-implementatie  
...
|**Alle pakket en programma-implementaties voor een specifieke gebruiker**|Geeft alle pakket- en programma-implementaties weer voor een opgegeven gebruiker.|  

### <a name="software-distribution---package-and-program-deployment-status"></a>Softwaredistributie - pakket en de Status van de programma-implementatie  

|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Alle system resource pakket en programma-implementaties met status**|Geeft alle pakket- en programma-implementaties voor de site weer met een samenvattingsstatus van elke implementatie.|  
...
|**Grafiek - Uurlijkse pakket en programma-implementatie voltooiingsstatus**|Geeft het percentage computers weer waarop het pakket is geïnstalleerd voor elk uur sinds het pakket- en de programma-implementatie is gemaakt. Dit kan worden gebruikt om de gemiddelde tijd bij te houden voor een implementatie van pakket en programma.|  
|**Implementatiestatus voor pakket en programma voor een specifieke client en implementatie**|Geeft de statusberichten weer die zijn gerapporteerd voor een opgegeven computer en pakket- en programma-implementatie.|  
...
|**Computers waarop een programma met gecontroleerde licente is geïnstalleerd, maar het programma niet zijn uitgevoerd sinds een opgegeven datum**|Geeft alle computers weer waarop een programma met gecontroleerde licentie is geïnstalleerd, zoals gerapporteerd door de software-inventarisatie, maar die het programma sinds een opgegeven datum niet hebben uitgevoerd.|  
|**Computers met een bepaald softwareprogramma**|Geeft een lijst weer van computers waarop programma’s zijn uitgevoerd die overeenkomen met de opgegeven softwaremeterregel binnen de opgegeven maand en het opgegeven jaar.|  
...
|**Trendanalyse gelijktijdig gebruik van een bepaald softwareprogramma**|Geeft het maximum aantal gebruikers weer die het opgegeven programma met gecontroleerde licenties tegelijkertijd hebben uitgevoerd gedurende elke maand van het afgelopen jaar.|  
...
|**Overzicht gebruik op tijdstip voor een bepaald softwareprogramma**|Geeft het gemiddelde gebruik van een bepaald programma weer in de afgelopen negentig dagen, opgedeeld per uur en dag.|  
...
|**Totaal gebruik voor alle programma's met gecontroleerde licenties die op Windows Terminal Servers**|Geeft het aantal gebruikers weer die programma's hebben uitgevoerd die overeenkomen met elke softwarelicentiecontroleregel met behulp van Terminal Services binnen de opgegeven maand en het opgegeven jaar.|  
|**Analyse van totaal gebruik voor een bepaald softwareprogramma**|Geeft het aantal gebruikers weer die programma's hebben uitgevoerd die lokaal overeenkomen met de opgegeven softwarelicentiecontroleregel, of met behulp van Terminal Services gedurende elke maand van het afgelopen jaar.|  
|**Analyse van totaal gebruik voor een bepaald softwareprogramma op Windows Terminal Servers**|Geeft het aantal gebruikers weer die programma's hebben uitgevoerd die overeenkomen met de opgegeven softwarelicentiecontroleregel met behulp van Terminal Services gedurende elke maand van het afgelopen jaar.|  
|**Gebruikers die een bepaald softwareprogramma zijn uitgevoerd**|Geeft een lijst weer van gebruikers die programma’s hebben uitgevoerd die overeenkomen met de opgegeven softwaremeterregel binnen de opgegeven maand en het opgegeven jaar.|  
...
|**Beheer 8 - Computers waarbij inhoud (secundair) ontbreekt**|Geeft alle computers weer die een opgegeven software-update vereisen die is opgenomen in een opgegeven implementatie die niet is ingericht op een distributiepunt.|  
...
|**Controle 4 - Clients van een site voor het melden van een specifieke status (secundair)**|Geeft alle computers weer die aan een opgegeven site zijn toegewezen en een opgegeven compatibiliteitscontrolestatus hebben geretourneerd tijdens de laatste compatibiliteitscontrole.|  

### <a name="software-updates---e-troubleshooting"></a>Software-Updates - E-probleemoplossing  

|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**1 - scanfouten oplossen**|Geeft controlefouten op de site en een telling van de computers waarbij elke fout optreedt weer.|  
|**2 - implementatiefouten oplossen**|Geeft de implementatiefouten op de site en een telling van de computers waarbij elke fout optreedt weer.|  
...
|**Onderdeelberichten voor het afgelopen uur**|Geeft een lijst van de statusberichten die zijn gemaakt in het afgelopen uur voor een opgegeven onderdeel op een opgegeven computer in een opgegeven Configuration Manager-site.|  
...
|**Aantal fouten in de afgelopen 12 uur**|Geeft het aantal serveronderdeelberichten in de afgelopen 12 uur weer.|  
...
|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Alle controleberichten voor een specifieke gebruiker**|Geeft een samenvatting weer van alle controlestatusberichten voor een opgegeven gebruiker. Controleberichten beschrijven acties uitgevoerd in de Configuration Manager-console toevoegen, wijzigen of verwijderen van objecten in Configuration Manager.|  
...
### <a name="task-sequence---deployment-status"></a>Takenreeks - Status van de implementatie  
...
|**Alle systeemresources voor een takenreeksimplementatie die zich in een specifieke status en die beschikbaar is voor onbekende computers**|Geeft een lijst weer van de doelcomputers voor de opgegeven takenreeksimplementatie in de opgegeven implementatiestatus.|  
|**Telling van systeemresources waaraan takenreeksimplementaties toegewezen maar nog niet uitgevoerd**|Geeft het aantal computers weer dat takenreeksen hebben geaccepteerd, maar deze nog niet hebben uitgevoerd.|  
...
|**Lijst met computers waarop een bepaalde tijdsduur voor het uitvoeren van een takenreeksimplementatie overschreden**|Geeft de lijst weer van doelcomputers die de opgegeven tijdsduur hebben overschreden voor het uitvoeren van een takenreeks.|  
...
|**Alle takenreeksimplementaties beschikbaar is voor onbekende computers**|Geeft details weer van alle takenreeksimplementaties die vanaf deze site zijn gestart en die zijn geïmplementeerd op verzamelingen die onbekende computers bevatten.|  
...
|**Voortgang van een takenreeks wordt uitgevoerd**|Geeft de voortgang weer van de opgegeven takenreeks.|  
...
|**Overzichtsrapport voor een takenreeksimplementatie**|Geeft de samenvattingsinformatie weer voor de opgegeven takenreeksimplementatie.|  
...
|**Voortgang van takenreeksen voor implementaties van besturingssystemen**|Geeft de voortgang weer van alle takenreeksen die besturingssystemen implementeren.|  
...
|**Upgrade assessment samenvatting**|Geeft de samenvatting weer van de upgradebeoordeling. Gebruik dit rapport om de algemene status voor upgradecompatibiliteit te beoordelen.|  

### <a name="user---device-affinity"></a>Gebruiker - Apparaataffiniteit  

|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**In afwachting apparaat affiniteitskoppelingen per verzameling**|Geeft alle in behandeling zijnde gebruikersapparaat-affiniteit-toewijzingen op basis van gebruiksgegevens weer voor leden van een verzameling.|  
|**Gebruiker apparaat affiniteitskoppelingen per verzameling**|Geeft alle associaties voor gebruikersapparaten voor de geselecteerd verzameling weer. De resultaten worden op verzamelingstype ingedeeld (bijvoorbeeld gebruiker of apparaat).|  
...
|**Computers met een specifiek virtueel toepassingspakket**|Geeft een samenvatting weer van computers die het opgegeven App-V-toepassingspakket hebben.|  
...
|Rapportnaam|Beschrijving|  
|-----------------|-----------------|  
|**Alle apparaten die zijn bestemd voor Wake On LAN-activiteit**|Geeft een lijst weer van alle computers waarop Wake On LAN-activiteit is gericht gedurende een implementatie van het type dat u opgeeft.|  
|**Alle objecten in afwachting van ontwaakactiviteit**|Geeft objecten weer die zijn ingepland voor ontwaken.|  
|**Alle sites die voor Wake On LAN geschikt zijn**|Geeft een lijst met alle sites in de hiërarchie weer die beschikbaar zijn voor Wake On LAN.|  
