---
title: Controlelijst voor 1802 | System Center Configuration Manager
titleSuffix: Configuration Manager
description: Meer informatie over acties moet uitvoeren voordat u bijwerkt naar System Center Configuration Manager versie 1802.
ms.custom: na
ms.date: 03/22/2018
ms.reviewer: na
ms.suite: na
...
---
# <a name="checklist-for-installing-update-1802-for-system-center-configuration-manager"></a>Controlelijst voor het installeren van update 1802 voor System Center Configuration Manager

*Van toepassing op: System Center Configuration Manager (huidige vertakking)*

Wanneer u de huidige vertakking van System Center Configuration Manager gebruikt, kunt u de update in de console voor versie 1802 bijwerken van uw hiërarchie van een eerdere versie installeren. <!-- baseline only statement: -->(Omdat de versie 1802 is ook beschikbaar als [basislijnmedia](/sccm/core/servers/manage/updates#a-namebkmkbaselinesa-baseline-and-update-versions), kunt u de installatiemedia voor het installeren van de eerste site van een nieuwe hiërarchie.)

Als u de update voor versie 1802, moet u een service connection point-sitesysteemrol op het hoogste niveau van uw hiërarchie. Dit kan zijn in de online of offline-modus. Nadat uw hiërarchie downloadt het updatepakket van Microsoft, kunt u deze vinden in de console onder **beheer &gt; overzicht &gt; Cloudservices &gt; Updates en onderhoud**.

-   Wanneer de update wordt vermeld als **beschikbaar**, de update is gereed om te installeren. Controleer de volgende informatie voordat u versie 1802 installeert, [over het installeren van update 1802](#about-installing-update-1802) en de [controlelijst](#checklist) voor configuraties die u moet voordat u de update start.
...
**Zorg ervoor dat alle sites een versie van System Center Configuration Manager dat ondersteunt naar 1802 bijwerken uitgevoerd:**   
Elke siteserver in de hiërarchie moet dezelfde versie van System Center Configuration Manager uitvoeren voordat u de installatie van update 1802 kunt starten. Als u wilt bijwerken naar 1802, moet u versie 1702, 1706 of 1710 gebruiken.

**Controleer de status van uw Software Assurance of gelijkwaardige abonnementsrechten:**   
U moet een actieve Software Assurance (SA)-overeenkomst voor het installeren van update 1802 hebben. Wanneer u deze update installeert de **Licensing** tabblad geeft de optie om te bevestigen dat uw **Software Assurance vervaldatum**.
...
Als u de site bijwerkt vóór de upgrade van Windows ADK, Zie [distributiepunten bijwerken met de installatiekopie](/sccm/osd/get-started/manage-boot-images#update-distribution-points-with-the-boot-image).
...
Voor een controle van vereisten uitvoeren vanaf de console, gaat u naar **beheer > overzicht > Cloudservices > Updates en onderhoud.** Vervolgens met de rechtermuisknop op **updatepakket voor Configuration Manager 1802**, en kies vervolgens **controle van vereisten uitvoeren**.
...
2.  Zorg ervoor dat elke siteserver en de sitesysteemrol is bijgewerkt naar versie 1802. In de console kunt u de optionele kolom toevoegen **versie** bij het weergeven van sommige knooppunten inclusief **Sites** en **distributiepunten**.
