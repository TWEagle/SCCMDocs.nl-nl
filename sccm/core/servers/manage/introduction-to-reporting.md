---
title: Inleiding tot rapportage | Microsoft-documenten
description: Meer informatie over de set van hulpprogramma&quot;s en bronnen beschikbaar voor het beheren van rapportage in Configuration Manager.
ms.custom: na
ms.date: 10/06/2016
...
-   Maakt gebruik van een bedrijfstak standaard rapportagesysteem om op te vragen van de Configuration Manager-database.  

-   Geeft rapporten weer met behulp van de Configuration Manager-rapportviewer of van Report Manager, een Webverbinding naar het rapport is.  
...
##  <a name="BKMK_ReportBuilder"></a> Report Builder  
 Configuration Manager maakt gebruik van Microsoft SQL Server Reporting Services Report Builder als exclusief ontwerp- en bewerkingsprogramma voor op basis van modellen en op basis van de SQL rapporten. Report Builder wordt geopend bij het starten van de actie van een rapport in de Configuration Manager-console maakt of bewerkt. Report Builder wordt automatisch geïnstalleerd als u een rapport voor de eerste keer maakt of wijzigt. De versie van Report Builder die aan de geïnstalleerde versie van SQL Server is gekoppeld, wordt geopend wanneer u rapporten uitvoert of bewerkt.  
