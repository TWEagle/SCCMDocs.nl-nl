...
1.  **Beleid voor Bedrijfsapparaten toevoegen**   
    ...
    2.  Op de **apparaatinstellingen registratie programma** pagina, geef de volgende informatie en klik vervolgens op **volgende**.  
    ...
    4.  Op de **aanvullend beheer** pagina, of een USB-verbinding kan worden gebruikt voor extra instellingen opgeven. Wanneer u selecteert **-certificaat vereist**, moet u een Apple Configurator-beheercertificaat voor dit profiel importeren.  Ingesteld op **Disallow** om te voorkomen dat synchroniseert bestanden met iTunes of beheer via Apple Configurator. Microsoft raadt u ingesteld op **Disallow**, een eventuele verdere configuratie vanuit Apple Configurator te exporteren en vervolgens implementeren als een aangepast iOS-configuratieprofiel, plaats deze instelling gebruiken voor handmatige implementatie met of zonder een certificaat.  
